...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
        ...
        <a href="{{ route('communities.create') }}" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs shadow-sm transition-colors">
            ...
            <div class="clean-card rounded-xl overflow-hidden flex flex-col justify-between group">
                <div>
                    ...
                    <div class="p-5 space-y-3 text-xs">
                        <div>
                            <h3 class="text-base font-bold text-slate-900 leading-tight">{{ $comm['name'] }}</h3>
                        ...
                        <div class="pt-2 border-t border-slate-100 flex justify-between items-center text-slate-500">
                            ...
                            <span class="text-emerald-700 font-semibold">{{ $comm['status'] }}</span>
                        </div>
                    </div>
                </div>

                <div class="p-5 pt-0">
                    <button onclick="showToast('Permintaan bergabung ke komunitas telah dikirim!')" class="w-full py-2 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold text-xs transition-colors">
                        Gabung Komunitas
                    </button>
                </div>
            </div>
