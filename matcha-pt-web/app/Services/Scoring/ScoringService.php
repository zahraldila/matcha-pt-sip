        ...
        try {
            ...
            if (! MatchParticipant::where('match_id', $match->match_id)->exists()) {
                if (! $matchContext) {
                    ...
                    $cachedSchedule = Cache::get("drawing.schedule_{$session->session_id}");
            ...
            Log::warning("Failed to ensure match and participants: {$e->getMessage()}");
